...
interface useContractPDFViewProps {
  pdfUrl: string;
}

interface ContractPDFViewProps extends useContractPDFViewProps {
  isOpen: boolean;
  onClose: () => void;
}

const ContractPDFView: React.FC<ContractPDFViewProps> = ({ isOpen, onClose, pdfUrl }) => {
...
export const useContractPDFView = (props: useContractPDFViewProps) => {  
  const [isOpen, setIsOpen] = useState(false);

  const modalRef = (
    <ContractPDFView isOpen={isOpen} onClose={() => setIsOpen(false)} pdfUrl={props.pdfUrl} />
  );
