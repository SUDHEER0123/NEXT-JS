...
interface PDFViewProps extends usePDFViewProps {
  isOpen: boolean;
  onClose: () => void;
}

const PDFView: React.FC<PDFViewProps> = ({ isOpen, onClose, pdfUrl }) => {
...
export const usePDFView = (props: usePDFViewProps) => {  
  const [isOpen, setIsOpen] = useState(false);

  const modalRef = (
    <PDFView isOpen={isOpen} onClose={() => setIsOpen(false)} pdfUrl={props.pdfUrl} />
  );
